...
c        call DEV4(I4)
c        call t4print(I4)
c        call testvonMises (SA)
c        call testvonMises (SB)
        call L4_EL(205e9_8,0.28_8,L4)
        call tc_4d2(L4,e1,s1)
c        call t2print(s1)
        call C4_EL(205e9_8,0.28_8,C4)
c        call tc_4d2(C4,s1,e1)
c        call t2print (e1)
        call tc_4d4(C4,L4,R4)
c
        call t4print(C4)  
        call t4print(R4)    
c
