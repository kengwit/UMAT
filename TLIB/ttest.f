...
c
        subroutine testvmbox (A)
c
         implicit none
         double precision, intent (inout) :: A(9)
         double precision :: seq, N(9), ph (9,9), ans
c
         call vm_box (A,2,seq,N,ph)
         call tc_2d2(N,N,ans)
         print *,"----------------"
         print *,"Begin VMBOX test"
         print *,"----------------"
         print *,"Input Tensor:"
         print *,
         call t2print (A)
...
c         print *,
         print *,"----------------"
         print *,"End VMBOX test  "
         print *,"----------------"
         return
c
        end subroutine testvmbox
c
